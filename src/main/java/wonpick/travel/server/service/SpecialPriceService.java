...
//        List<SpecialPricePick> specialPrices = specialPriceRepository.findCurrentSpecialPrices(LocalDateTime.now());

        List<SpecialPriceDTO> specialPriceDTOs = specialPriceRepository.findAllWithMinPrice();
